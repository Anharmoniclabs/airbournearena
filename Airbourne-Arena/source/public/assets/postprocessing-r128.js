/* Post-processing chain for the bloom pass, vendored from three.js r128
   examples/js (the UMD builds that attach to the THREE global, not the ES
   modules — the game is one concatenated IIFE loaded from a plain script
   tag and has to stay openable from file://).

   Order matters: Pass defines the base every pass extends, and the shaders
   have to exist before the passes that name them. Regenerate with
   source/scripts/vendor-postprocessing.sh */
